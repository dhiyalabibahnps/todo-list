  ...
  return (
    <main className="font-mono px-4">
      <div className="max-w-5xl mx-auto pb-6">
        <nav className="sticky top-0 pt-8 mb-8 bg-emerald-300">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <h1 className="text-4xl font-bold mb-6 text-center">Tugas Saya</h1>
          ...
          <form className="flex flex-row" onSubmit={addTask}>
            <input
              name="task"
              className="flex-grow p-2 text-lg border-4 border-r-0 border-black focus:outline-none"
        ...
        <div className="flex space-x-2 transition-all duration-100 overflow-y-scroll no-scrollbar">
          {tabs.map((tab, index) => (
            <Tab
              key={index}
              {...tab}
